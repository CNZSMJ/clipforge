...
export const settings: NamespaceMessages = {
  zh: {
    ...
    presetFalTip: "一个 fal Key 同时给脚本/看图/生图/生视频/配音；可读取 OpenRouter 公共模型目录，选定后测试连接",
    ...
    modelListPublicButton: "读取模型目录",
    modelListPublicNote: "目录来自 OpenRouter 公共接口，不会发送你的 Fal Key。目录不代表账户调用权限；选择文本或支持看图的视觉模型后，请测试连接。读取目录不会修改当前模型。",
    modelListPublicFailed: "暂时无法读取 OpenRouter 公共模型目录，请稍后重试或手动填写模型名。这不代表你的 Fal Key 失效。",
    modelListAuthFailed: "模型列表接口拒绝了凭证，请检查 API Key 及其访问权限。",
    modelListUnsupported: "此服务不支持读取模型列表，请手动填写模型名；这不代表聊天接口不可用。",
    modelListTimedOut: "读取模型目录超时，请检查网络后重试，也可手动填写模型名。",
  ...
  en: {
    ...
    presetFalTip: "One fal key covers script, vision, image, video and voiceover; browse the public OpenRouter catalogue, then test the selected model",
    ...
    modelListPublicButton: "Read model catalogue",
    modelListPublicNote: "Source: OpenRouter's public API. Your Fal key is not sent. This catalogue does not verify account access; test the selected text or image-capable vision model. Reading the catalogue does not change your current model.",
    modelListPublicFailed: "OpenRouter's public catalogue is temporarily unavailable. Retry later or enter a model name manually. This does not mean your Fal key is invalid.",
    modelListAuthFailed: "The model-list endpoint rejected the credentials. Check your API key and access permissions.",
    modelListUnsupported: "This service does not support model listing. Enter a model name manually; its chat endpoint may still work.",
    modelListTimedOut: "The catalogue request timed out. Check the network and retry, or enter a model name manually.",
