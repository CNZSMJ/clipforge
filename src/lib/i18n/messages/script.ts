...
export const script: NamespaceMessages = {
  zh: {
    ...
    aiFilmNeedModels: "还没配好生图/视频模型——到设置里的「生图模型」和「视频模型」各选一个（推荐 fal.ai 一个 Key 全搞定）",
    // 保存模板弹窗
  ...
  en: {
    ...
    aiFilmNeedModels: "No image/video model configured yet — pick one under Settings → Image model and Video model (fal.ai covers both with one key)",
